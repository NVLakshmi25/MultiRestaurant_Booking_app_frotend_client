            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-7 h-[450px] overflow-hidden">
                    <img
                        ...
                        alt="Chef's Table dining experience"
                ...
                <div className="lg:col-span-5 flex flex-col justify-center lg:pl-6">
                    ...
                    <p className="text-sm text-black/55 mb-8 leading-relaxed">
                        Join QuickDine and receive priority access to
                        seasonal chef collaborations, private dining
                        club events, and table guarantees at
                        high-demand tables.
                    </p>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-black/55 mt-1 leading-relaxed">
                                    Unlock tables held exclusively
                                    for club members during peak
                                    weekends.
                                </p>
                            </div>
                        </div>
